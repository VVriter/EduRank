<template>
    <nav>
        <el-card shadow="hover" style="border-radius: 10px;" :class="'desktop' + ' ' + minimizeded">
            <el-row>
                ...
                <el-row style="margin-left: auto; margin-top: auto; margin-bottom: auto;">
                    <ThemeSwitcher />
                    <el-button round size="large" plain @click="goto('GPSSearch')">Пошук по GPS</el-button>
                    <el-button round size="large" plain @click="goto('EJournal')">Є-Журнал</el-button>
                    <el-button round size="large" plain @click="goto('Donate')">Донат</el-button>
                </el-row>
            </el-row>
        </el-card>
